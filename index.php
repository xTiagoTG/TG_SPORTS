    ...
    <header id="main-header">
        <div class="row">
            ...
            <nav id="nav-wrap">
                ...
                <div id="logo">
                    <a href="#top"><img src="images/logotipo.PNG" alt="Your Logo"></a>
                </div>
                <ul id="nav" class="nav">
                    <li><a class="smoothscroll" href="#hero">Inicio</a></li>
                    <li><a class="smoothscroll" href="#historia">História</a></li>
                    <li><a class="smoothscroll" href="#Campeonatos">Campeonatos</a></li>
                    <li><a class="smoothscroll" href="#Clubes">Clubes</a></li>
                    <li><a class="smoothscroll" href="#Premios">Prémios</a></li>
                    <li><a class="smoothscroll" href="#Estrelas">Estrelas</a></li>
                    <li><a class="smoothscroll" href="#contact">Contactos</a></li>
                    <li><a class="smoothscroll" href="#" id="registerBtn">Registar</a></li>
                </ul> <!-- end #nav -->
            </nav> <!-- end #nav-wrap -->
        </div>
                        ...
                        <ul class="slides">
                            <li>
                                <div class="flex-caption">
                                    <h1>TG SPORTS+</h1>
                                    <h3>TG SPORTS+ é um site onde podes ver os jogadores e os seus respetivos clubes.</h3>
                                </div>
                            </li>
                            <li>
                                <div class="flex-caption">
                                    <h1>TG SPORTS+</h1>
                                    <h3>No TG SPORTS+ também podes ter acesso às ligas dos clubes mais conhecidos da Europa.</h3>
                                </div>
                            </li>
                            <li>
                                <div class="flex-caption">
                                    <h1>TG SPORTS+</h1>
                                    <h3>No TG SPORTS+ podes ver prémios que são atribuídos aos jogadores mais destacados do ano.</h3>
                                </div>
                            </li>
                        </ul>
                    </div> <!-- end hero-slider -->
        ...
        <section id="historia">
            <div class="row section-head">
                <div class="twelve columns">
                    ...
                    <hr />
                    <p><font color="white" face="Arial, sans-serif">> O futebol, essa paixão que une nações em torno de uma bola, tem uma história tão cativante quanto os jogos que vemos nos estádios hoje. Começou no século XIX, em Inglaterra, quando alguém teve a ideia genial de criar regras jogos de bola.</font></p>
                    <p><font color="white" face="Arial, sans-serif">> A bola jogou-se mundo fora, conquistando corações em lugares tão diversos como o Brasil, Argentina e tantos outros.Em 1930, no Uruguai, tivemos o primeiro Mundial de Seleções, o grande encontro internacional que consolidou o futebol como uma linguagem global.</font></p>
                    <p><font color="white" face="Arial, sans-serif">> Hoje, não faltam competições emocionantes, como a Champions League na Europa e a Libertadores na América do Sul. O futebol é mais do que um jogo; é cultura, é moda, é parte do nosso quotidiano.</font></p>
                    <p><font color="white" face="Arial, sans-serif">> Com a tecnologia dando uma ajudinha, o VAR chegou para esclarecer aquelas decisões polémicas que sempre geram discussões acaloradas. O futebol é como um livro em constante escrita, com cada jogo adicionando um novo capítulo à sua rica história. Assim, se és fã de golos, emoções e dessa ligação única que o futebol cria entre as pessoas, estás no sítio certo.</font></p>
                </div>
...
É disputada por vinte clubes no sistema de pontos corridos, em que no final de cada temporada os quatro melhores colocados participam da Liga dos Campeões da UEFA, e os três piores são rebaixados para a EFL Championship, dando lugar aos três melhores desta competição. Cada temporada decorre entre agosto e maio, tendo 38 rodadas com dez partidas cada, totalizando 380 partidas em toda a temporada. A maioria dos jogos são disputados durante o período da tarde nos sábados e domingos e algumas vezes durante a noite no meio da semana.</p>
         ...
         <div id="modal-02" class="popup-modal mfp-hide">
            ...
            <div class="link-box">            	
               <a href=http://www.legaseriea.it/en>Saber Mais</a>
		         <a href="#" class="popup-modal-dismiss">Sair</a>
            </div>
      ...
      <div class="row mobile-no-padding">      	
	      ...
	      <div class="service-list bgrid-third s-bgrid-half tab-bgrid-whole group">
	      	...
	      	<div class="bgrid">	               
	            ...
	            <h3><font color="yellow" face="Arial, sans-serif">Premier league</font></h3>
	          ...
	          <div class="service-content">	                  
	            ...
	            <h3><font color="yellow" face="Arial, sans-serif">Série A</font></h3>                  
			   ...
			   <div class="bgrid">	              
	            ...
	            <h3><font color="yellow" face="Arial, sans-serif">LaLiga</font></h3>
                 <div class="service-content">	                  
		            <table>
					<tr>
	            ...
	            <h3><font color="yellow" face="Arial, sans-serif">Bundesliga</font></h3> 
                <div class="service-content">	                  
		            <table>
					<tr>
			   ...
			   <div class="bgrid">
	            ...
	            <h3><font color="yellow" face="Arial, sans-serif">League 1</font></h3>
                <div class="service-content">	                  
		            <table>
					<tr>
			   ...
			   <div class="bgrid">	               
	            ...
	            <h3><font color="yellow" face="Arial, sans-serif">Primeira liga</font></h3>
                <div class="service-content">	                  
		            <table>
					<tr>
      ...
      <div class="row mobile-no-padding">       	
      	...
      	<div class="process bgrid-half tab-bgrid-whole group">
      		...
      		<div class="bgrid">
			      ...
			      <h3><font color="yellow" face="Arial, sans-serif">Bola de Ouro</font></h3>	
...
<h3><font color="yellow" face="Arial, sans-serif">Bota de ouro</font></h3>
...
<h3><font color="yellow" face="Arial, sans-serif">World Soccer</font></h3>	
...
<h3><font color="yellow" face="Arial, sans-serif">Golden Boy</font></h3>
...
<h1><font color="yellow" face="Arial, sans-serif"><span>Estrelas do Futebol Mundial</span></font></h1>
...
<!-- form -->
<form name="contactForm" id="contactForm" method="post" action="processar_formulario.php">
...
<p>
<font color="white" face="Arial, sans-serif">tg1904650@gmail.com </font>
</p>

<h3>Número de Telemóvel</h3>
<p><font color="white" face="Arial, sans-serif">Telemóvel: 960124992 </font><br>
